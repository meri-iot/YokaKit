...
class ProductionPlannedOutageRepository extends AbstractRepository
{
     ...
     * このリポジトリが扱うモデルクラスを返す
     *
     * @return class-string<ProductionPlannedOutage>
     */
    ...
    {
        $productionPlannedOutage = new ProductionPlannedOutage([
        ...
        return $this->storeModel($productionPlannedOutage);
    }

    /**
     * 計画停止時間の開始と終了までの区間の配列を取得する。
     *
     * 同一時間帯の重複区間をマージし、日付をまたぐ区間(例: 23:00-01:00)は
     * 00:00 を境界として [00:00-01:00] と [23:00-00:00] のように分割して返す。
     *
