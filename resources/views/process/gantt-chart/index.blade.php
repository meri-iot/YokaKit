...
@section('title', $process->process_name . '：' . __('yokakit.gantt_chart'))
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            @foreach ($processes as $p)
                @if ($p->ganttCharts->count() != 0)
                    <x-adminlte-card title="{{ $p->process_name }}" maximizable="true" collapsible>
                        <x-slot name="toolsSlot">
                            <a class="btn btn-tool" href="{{ route('process.show', ['process' => $p]) }}">
                            ...
                            <div class="row">
                                ...
                                @foreach ($works as $work)
                                    <div class="col-auto mr-2">
                                        <h5>
                                            <span>
                                                <i class="fa-solid fa-fw fa-square" style="color: {{ $work->chart_color }}"></i>
                        ...
                        <div class="chart mx-auto">
                            ...
                            <canvas class="chartjs-render-monitor" id="gantt-chart-{{ $p->process_id }}"></canvas>
                        </div>
                    </x-adminlte-card>
                @endif
            @endforeach
