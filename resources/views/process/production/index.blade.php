                ...
                <div class="col d-flex justify-content-end">
                    <div class="d-flex justify-content-end flex-wrap">
                        <div class="align-self-end col-auto">
                            <x-select id="part_number_name" name="part_number_name" label="{{ __('yokakit.part_number') }}" :options="$partNumbers"
                                icon="hammer" empty="true" selected="{{ request('partNumberName') }}" />
                        </div>
                        <div class="align-self-end col-auto">
                            <x-daterange id="date-range" name="date-range"></x-daterange>
                        </div>
                        <div class="align-self-end col-auto">
